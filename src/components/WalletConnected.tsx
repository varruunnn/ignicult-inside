...
// New pulsing green loader variants
const greenLoaderVariants = {
      ...
      <div className="max-w-4xl mx-auto">
        {loading ? (
          <motion.div
            ...
            animate={{ opacity: 1 }}
          >
            <motion.div variants={greenLoaderVariants} initial="initial" animate="animate">
              <Loader2 className="w-12 h-12 text-green-500" />
            </motion.div>
            <p className="mt-4 text-green-500">Loading wallet data...</p>
          </motion.div>
        ) : walletData ? (
          <motion.div className="space-y-8">
            <motion.div className="text-center space-y-4" variants={itemVariants}>
              ...
              >
                <h2 className="text-2xl ml-[-40px] md:absolute md:top-[3.6%] md:left-[10%] flex items-center gap-3">
                  <Wallet className="w-8 h-8 max-[480px]:hidden" />
                  Wallets Connected
                </h2>
                <img src="/blackLOgo.svg" className="w-9 h-9 md:absolute md:right-[2%] md:top-[3.5%]" alt="" />
              </motion.div>
              <div className="w-full h-[1px] bg-amber-500 my-4 md:absolute md:top-[14%] md:left-0"></div>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <motion.div className="mt-8 pt-8 border-t border-slate-700/50 text-center" variants={itemVariants}>
