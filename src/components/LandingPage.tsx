...
const AnimatedText: React.FC<AnimatedTextProps> = ({ text, delay = 0, initialY = -20 }) => {
  ...
  return (
    <div style={{ display: 'inline-block', fontSize: '2.5rem',fontWeight: 300 , fontFamily: 'Poppins' }}>
  ...
  return (
    <div className="min-h-screen  bg-[#1D1D1D] text-white font-sans relative overflow-hidden">
      ...
      >
        ...
        />
        <AnimatedText text="Ignicult-Inside" initialY={-20} />
        ...
        >
          ...
          <p className="text-gray-400 text-sm">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsa, sapiente.</p>
        </motion.div>
              ...
              {[
                ...
                >
                  <button
                    ...
                    className="block px-6 py-3 border-[#FFB000] border-[0.5px] cursor-pointer bg-[#1D1D1D]  rounded-xl hover:bg-gray-800 transition-colors duration-300 hover:text-black text-white no-underline"
                  >
                    <span className="bg-clip-text text-transparent  bg-gradient-to-r from-[#FF0000] to-[#FFF600]">
                      {option.text}
                    </span>
