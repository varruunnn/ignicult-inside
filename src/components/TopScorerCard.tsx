...
const TopScorerCard: React.FC<Props> = ({
  ...
  return (
    <div className="min-h-screen flex mt-[80px] items-center justify-center bg-[#1D1D1D] p-4">
      <div className="grid grid-cols-2 gap-4 max-w-4xl w-full rounded-xl shadow-lg p-4 bg-[#1D1D1D]">
        <div className="rounded-lg p-4 w-[150%] flex flex-col justify-center bg-gradient-to-tr from-green-700 to-[#284229]">
          <p className="text-sm font-medium text-white opacity-90">Achieved By</p>
          <h2 className="text-2xl font-bold text-white mt-1 truncate">{achievedBy}</h2>
        </div>
        <div className="rounded-lg p-4 w-[50%] relative left-[50%] flex flex-col justify-center bg-gradient-to-tr from-green-700 to-[#284229]">
        ...
        <div className="flex flex-row gap-4">
          <div className="rounded-lg p-4 flex flex-col items-center bg-gradient-to-tr from-[#3511FF] to-cyan-600 w-[50%]">
            <p className="text-sm font-medium text-white opacity-90">Mean Time</p>
            <h2 className="text-2xl font-bold text-white mt-1">
              <CountUp target={meanTime} duration={2} format={(n) => n.toFixed(2)} />
            </h2>
          </div>
          <div className="rounded-lg p-4 flex flex-col items-center bg-gradient-to-tr from-green-700 to-[#FF1911] w-[50%]">
